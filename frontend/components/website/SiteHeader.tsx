...
export default function SiteHeader({
  ...
  return (
    <header className="sticky top-0 z-30 bg-white border-b border-[#E8DFD0] shadow-sm">
      <div className={`${maxWidth} mx-auto px-3 md:px-6 h-16 flex items-center justify-between gap-2 relative`}>
        ...
        <div className="absolute left-1/2 -translate-x-1/2">
          {logoUrl ? (
            ...
            <span className="text-lg font-bold text-[#1A1613] whitespace-nowrap">{brandName}</span>
          )}
        </div>
